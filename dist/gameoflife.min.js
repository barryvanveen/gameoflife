...
$('.game1_start').click(function () {
    BigGame.start();
});
$('.game1_stop').click(function () {
    BigGame.stop();
});
$('.game1_step').click(function () {
    BigGame.step();
});
$('.game1_reset').click(function () {
    BigGame.reset();
});
...
$('.game2_start').click(function () {
    SmallGame.start();
});
$('.game2_stop').click(function () {
    SmallGame.stop();
});
$('.game2_step').click(function () {
    SmallGame.step();
});
$('.game2_reset').click(function () {
    SmallGame.reset();
});
